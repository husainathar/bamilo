...
class Ajax_pagination{
    ...
    function create_links(){
		...
		function getData(page){
			...
			var fundCategoryId = $.trim($('#hdnFundCategoryId').val());
			var searchCriteria = $.trim($('#hdnSearchCriteria').val());
			var searchValue = $.trim($('#hdnSearchValue').val());
			var fundSubCategoryId = $.trim($('#hdnFundSubCategory').val());
			var searchObj = {
				page:page,
			...
			$('#postList').load("<?php echo $this->base_url; ?>",{searchObj:JSON.stringify(searchObj)},function(data){
